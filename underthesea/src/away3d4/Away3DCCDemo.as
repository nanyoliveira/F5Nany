package  away3d4 {
	...
	import away3d4.com.in2ar.away3d.Away3DCameraLens;
	import away3d4.com.in2ar.away3d.Away3DCaptureTexture;

	import base.CaptureController;
	import base.IN2ARBase;
	import base.net.hires.debug.Stats;
    ...
    public class Away3DCCDemo extends IN2ARBase
    //public class Away3DCCDemo extends IN2ARNativeBase
    {
        // tracking data file
        ...
        private function initText():void
        {
            ...
            stat = new Stats();
            stat.y = stage.stageHeight - 100;
            stat.x = stage.stageWidth - 70;
            addChild(stat);
        }
        ...
        private function newWebCamFrame(e:Event):void
        {
            ...
            if(downScaleRatio != 1){
                ...
                // add frame to in2ar buffer
                in2arLib.addBitmapFrame(workBuffer);
            } else {
                // add frame to in2ar buffer
                in2arLib.addBitmapFrame(frameBitmap);
            }

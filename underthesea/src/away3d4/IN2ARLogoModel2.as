package  away3d4 {
	...
	import away3d4.com.in2ar.away3d.Away3DContainer;
     ...
     */
    public class IN2ARLogoModel2 extends Away3DContainer 
    {
        [Embed(source = "../assets/in2ar_logo/logo.png")] 
        private static var Charmap:Class;
        
        [Embed(source = "../assets/in2ar_logo/logo_normals.obj", mimeType = "application/octet-stream")] 
        ...
        public function IN2ARLogoModel2(maxDropFrames:int = 2) 
        {
            super(maxDropFrames);
            initObjects();
        }
